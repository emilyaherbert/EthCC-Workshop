...
impl Voting for Contract {
    ...
    fn get_favorite_number() -> u64 {
        ...
        // TODO
        //
        // 1. return the current favorite number
    ...
    fn get_number_of_votes(number: u64) -> u64 {
        ...
        // TODO:
        //
        // 1. return the number of votes for number found in storage.number_votes
        //
        // NOTE:
        //
        // 1. consider the case in which the number passed in is higher than MAX_NUM
        //    in this case, use a require statement and return UserError::InvalidNumber
